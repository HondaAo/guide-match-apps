...
const ChatScreen = ({ match }) => {
  ...
  useEffect(()=>{
    ...
    { chats ? (
      ...
      <Button variant="primary"><Link to={`/chatforguide/${userInfo._id}`} style={{color: 'white', textDecoration: 'none'}}>Go Chat page for guide</Link></Button>
      ): null
      ):null}
      </div>
      <hr />
